  ...
  return (
    <div className="flex-col flex justify-center w-full min-h-[80vh] text-left px-4 sm:px-4 md:px-8 lg:px-24 xl:px-32 animate-slide-in-right-to-left">
      ...
      <section className="mb-6">
        ...
        <p className="text-base sm:text-lg leading-relaxed">
          ArchAi employs large language model (LLM)-driven automation to assist
          in the planning and automatic generation of cloud architectures,
          ensuring scalability, security, and cost-efficiency. The platform
          interprets high-level user input and generates optimized
          infrastructure blueprints based on best practices.
        </p>
      </section>
